		...
		<form method="get" action="<%= request.getContextPath() %>/simple-search" class="form-horizontal col-md-12 form-group form-group-lg" scope="search" role="form">
			...
			<div id="logo-deposita" class="text-center">
				<a  id="link-logo-deposita" href="<%= request.getContextPath() %>/community-list">
					<img src="<%= request.getContextPath() %>/image/logo.png" usemap="#mapa-brasil">		
				</a>
			</div>
			
			
		<div class="col-md-11 searchbox col-md-offset-2">
			<div class="col-md-8">
			...
			<div class="col-md-1">
			   <button type="submit" class="btnpesquisa btn-primary pull-right search-button"><span class="glyphicon glyphicon-search"></span></button>
			</div>
		</div>
