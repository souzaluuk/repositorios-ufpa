...
%>
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
        ...
        <li class="dropdown-header"><fmt:message key="jsp.layout.navbar-default.browseitemsby"/></li>
          ...
          <li><a href="/jspui/statistics"><fmt:message key="jsp.layout.navbar-admin.statistics"/></a></li>
          <li class="dropdown">
             ...
             <ul class="dropdown-menu">
				...
				--%>
             	...
             	<li><a target="_blank" href="<%= request.getContextPath() %>/DIRETRIZES GERAIS BDM.pdf">Diretrizes</a></li>
				<li><a target="_blank" href="http://bcficat.ufpa.br/">Ficha Catalográfica</a></li>
				<li><a target="_blank" href="http://bc.ufpa.br/wp-content/uploads/2018/03/Guia_de_Elaboracao_de_Trabalhos_Academicos.pdf">Guia de Trabalhos Acadêmicos</a></li>
				<li><a target="_blank" href="<%= request.getContextPath() %>/Termo de Autorizacao e Declaracao de Autoria.pdf">Termo de Autorização</a></li>
             </ul>
          </li>
		  <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown"><%--<fmt:message key="jsp.layout.navbar-default.downloads"/>--%>Downloads<b class="caret"></b></a>
             <ul class="dropdown-menu">
				<li><a target="_blank" href="https://github.com/souzaluuk/dspace-installer">DSpace Installer</a></li>
             </ul>
          </li>
